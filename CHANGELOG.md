...
- **actions**: add create-signed-commit composite action for GitHub-signed bot commits
  (#1044) (739b776)
...
- **deps**: update github-actions (#954) (334eeae)
- **deps**: update dependency lgtm-hq/lgtm-ci to 0.74.4 (minor) (#958) (aac9250)

### Fixed

- **deps**: update lintro (#1019) (50d4eee)

## [0.74.4] - 2026-09-16

### Fixed

- **deps**: update lintro (#1017) (688389a)

## [0.74.3] - 2026-09-16

### Fixed

- **release**: range the version-PR changelog from the latest stable tag (#1013)
  (3f3162b)
...
- **release**: ignore prerelease tags when computing the next version (#1000) (4bc002d)
...
- **deps**: update lintro (#953) (d739bd3)
...
- **deps**: update lintro (#943) (230e3b3)

## [0.69.7] - 2026-09-07

### Changed

- **deps**: lock file maintenance (#940) (5ca0f83)
- **deps**: update renovatebot/github-action action to v46.2.6 (patch) (#939) (eee7d8c)
- **deps**: update dependency lgtm-hq/lgtm-ci to 0.69.6 (patch) (#938) (9f53c44)

### Fixed

- **deps**: update lintro (#941) (f062d05)
...
- **deps**: update dependency lgtm-hq/lgtm-ci to 0.69.2 (patch) (#922) (e7a268e)

### Fixed

- **deps**: update lintro (#927) (b82d2e0)

## [0.69.3] - 2026-09-05

### Changed

- **deps**: update step-security/harden-runner (#916) (44bbb92)

### Fixed

- **deps**: update lintro (#925) (5631a33)
- **deps**: update lintro (#924) (7714930)
- **deps**: update lintro (#921) (9629769)
...
- **deps**: update lintro (#909) (be7ee29)

## [0.69.0] - 2026-08-31

### Added

- **ci**: probe raw job-log availability when --log-failed is empty (#794) (#911)
  (22d225a)

### Changed

- add Cloud Agent development environment setup (#859) (d609e22)
- **deps**: update dependency anchore/syft to v1.51.1 (patch) (#907) (a24d22c)
...
- resolve AI review model and cost from repo vars (3cfdc67)

### Fixed

- **deps**: update lintro (#884) (c23ca22)
...
- **ci**: pilot caller for reusable-ai-review — lintro-review[bot] on this repo's PRs
  (#889) (b1189ca)
...
- **deps**: update dependency lintro to 0.123.2 (patch) (#883) (90eb7a6)
- **deps**: update lintro (#882) (33c78f0)
- **deps**: update lintro (#880) (bc29ee5)
- **deps**: update lintro (#879) (b25acf4)
- **deps**: update lintro (#877) (c7eb17e)
...
- **deps**: update dependency lgtm-hq/lgtm-ci to 0.63.3 (patch) (#869) (75ba915)

### Fixed

- **ci**: shrink shell-tests log noise (kcov debris, annotations, LINENO) (#863)
  (16a7a7e)
...
- **deps**: update dependency lgtm-hq/lgtm-ci to 0.63.1 (minor) (#807) (6450b1e)
- **deps**: update github-actions (#822) (9109623)
- **deps**: update dependency anchore/syft to v1.51.0 (minor) (#767) (3fcf4c0)

### Fixed

- **deps**: update lintro (#858) (c03d421)
...
- **deps**: update lintro (#813) (5a8332f)
- **deps**: update lintro (#812) (5eca67c)
- **deps**: update lintro (#810) (6313cf4)
...
- **workflows**: make reusable-build-artifact toolchain-agnostic (#795) (aa2ce5f)
...
- **deps**: update renovatebot/github-action action to v46.1.21 (patch) (#791) (de330ad)
- **deps**: lock file maintenance (#789) (10fac98)

### Fixed

- **deps**: update lintro (#790) (077ac44)

## [0.59.29] - 2026-07-26

### Fixed

- **ci**: remove unreachable coverage merge step from reusable-test-python (#781)
  (2eea77c)
- **deps**: update lintro (#786) (885dc0e)

## [0.59.28] - 2026-07-26

### Fixed

- **release**: merge changelog PR references on every dedup path (#780) (e247555)

## [0.59.27] - 2026-07-26

### Fixed

- **deps**: update dependency lintro to 0.91.53 (patch) (#783) (6c1eeb1)
- **ci**: stop auto-rerun hanging in a quadratic bash expansion (#784) (a17bdbe)
...
- **ci**: classify the scopes reusable-sbom and the Pages publishers force on callers
  (#771) (29aa57b)

### Fixed

- **deps**: update dependency lintro to 0.91.51 (patch) (#774) (c5688ab)
- **release**: match changelog duplicates by feature subject (#757) (f0f5366)
...
- **release**: make create-github-release rerun-safe (#758) (6b69e17)
- **deps**: update dependency lintro to 0.91.49 (patch) (#769) (777a5c5)

## [0.59.22] - 2026-07-26

### Fixed

- **ci**: make the auto-rerun safety net non-fatal on every log-fetch outcome (#749)
  (efbc8c4)
...
- **ci**: namespace e2e-matrix artifacts with artifact-prefix (#752) (54afb09)
...
- **ci**: retry transient OIDC failures on cosign sign-blob paths (#732) (8862932)

## [0.59.13] - 2026-07-25

### Fixed

- **ci**: retry failed-job log fetch and report unavailable logs as inconclusive (#723)
  (acdf8e0)
...
- **deps**: update lintro (#718) (6245e47)
- **ci**: retry transient OIDC failures when cosign-signing images (#722) (8a163ef)

## [0.59.11] - 2026-07-25

### Fixed

- **reusable-quality-lint**: overwrite linting-report so retries publish the
  authoritative run (#724) (deb8687)
...
- **reusable-quality-lint**: make report upload non-fatal instead of classifying its
  failures (#696) (a66497e)
- **deps**: update lintro (#704) (0b12601)
...
- **deps**: update github-actions (#679) (61ae56e)

### Fixed

- **deps**: update lintro (#692) (8852491)
- **deps**: update lintro (#690) (ecbef50)

## [0.59.4] - 2026-07-24

### Changed

- **changelog**: consolidate duplicate 0.56.0 and 0.57.0 feature entries (#653)
  (bd1ecef)

### Fixed

- **deps**: update lintro (#689) (67a4fb7)
- **deps**: update lintro (#687) (71395f3)
...
- **deps**: update lintro (#685) (bce0d37)
...
- **deps**: update dependency lintro to 0.80.8 (patch) (#616) (4022d0d)
...
- **release**: skip version-PR updates when merge-queued (#546) (745c154)

## [0.52.8] - 2026-07-12

### Fixed

- **sbom**: scope contents:write to release-asset upload job (#545) (0f75b46)

## [0.52.7] - 2026-07-12

### Changed

- **pages**: replace stale publish-test-results v0.23.0 pin (#543) (7fa7c61)
- **changelog**: move verify-tags default flip to v0.48.2 (#542) (f8eaa28)

### Fixed

- **test**: harden port flake and registry empty-name assertions (#544) (f4b9751)

## [0.52.6] - 2026-07-12

### Fixed

- **deps**: update dependency lintro to 0.78.2 (patch) (#538) (3303f38)

## [0.52.5] - 2026-07-12

### Changed

- **org**: registry reflects 📌 pinning canon for Rustume and holy-grail (#537) (e5efe82)

### Fixed

- **ci**: avoid lychee-action output conflict in link-check (#531) (c316f06)
...
- **ci**: grant contents:write for SBOM release asset upload (#505) (39073e8)
...
- **ci**: ratchet BATS coverage for release + docker digest scripts (#500) (009cff3)

### Fixed

- **deps**: update ghcr.io/lgtm-hq/py-lintro digest (#485) (a902dde)
...
- **deps**: update ghcr.io/lgtm-hq/py-lintro digest (#472) (a2b9597)

## [0.50.1] - 2026-07-10

### Fixed

- **deps**: update ghcr.io/lgtm-hq/py-lintro digest (#470) (2d963a5)

## [0.50.0] - 2026-07-10

### Added

- **ci**: align reusable npm publish with OIDC trusted publishing + Node 24 (#465)
  (cd59086)

### Changed

- **actions**: wrap dorny/paths-filter in detect-changes (#468) (2ddc8b4)
...
- **security**: restore harden-runner pre hook via direct step-security invocation
  (#467) (ba6c707)
- **deps**: update ghcr.io/lgtm-hq/py-lintro digest (#464) (255fd45)
...
- **quality**: enforce per-job timeout-minutes with documented exception list (#460)
  (8e5cd1b)
- **docker**: add exact-tags backfill mode to reusable-docker (#449) (3574276)
...
[0.59.27]: https://github.com/lgtm-hq/lgtm-ci/compare/v0.59.26...v0.59.27
...
[0.59.11]: https://github.com/lgtm-hq/lgtm-ci/compare/v0.59.10...v0.59.11
...
[0.52.6]: https://github.com/lgtm-hq/lgtm-ci/compare/v0.52.5...v0.52.6
[0.52.5]: https://github.com/lgtm-hq/lgtm-ci/compare/v0.52.4...v0.52.5
...
[0.49.0]: https://github.com/lgtm-hq/lgtm-ci/compare/v0.48.2...v0.49.0

...
```yaml
uses: lgtm-hq/lgtm-ci/.github/workflows/reusable-quality-lint.yml@f2b35cdad10df33b60c2996570b3848b70f55ed1 # v0.69.7
with:
  tooling-ref: "f2b35cdad10df33b60c2996570b3848b70f55ed1" # v0.69.7
```

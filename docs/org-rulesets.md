...
| `checks-rustume-ops`       | `19427364` | `rustume-ops`       | `semantic-title / 📝 Validate PR Title`, `security-audit / 🔐 Security Audit`, `validate / 📌 Validate Action Pinning`, `Terraform fmt & validate`, `shell-tests / Backup Shell Tests`, `shell-tests / Railway Shell Tests`                                                                                                                                                                                                           |
...
(2026-07-21); each caller posts an always-reporting aggregate gate via

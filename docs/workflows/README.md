...
| `reusable-auto-rerun-on-infra-failure.yml` | Re-run failed jobs on transient infra outage signatures (capped by `max-reruns`; never for protected publish/promote workflows or jobs) |
